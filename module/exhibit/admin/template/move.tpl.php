...
<?php echo category_select('fromcatid[]', '', 0, $moduleid, 'size="2" multiple  style="height:300px;width:96%;"');?>
</div>
...
<td width="45%"><?php echo category_select('tocatid', '', 0, $moduleid, 'size="2" style="height:300px;width:96%;"');?></td>
</tr>
<tr>
