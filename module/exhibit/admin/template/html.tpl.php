...
<input type="submit" value=" 生成列表 " class="btn" onclick="this.form.action='?moduleid=<?php echo $moduleid;?>&file=<?php echo $file;?>&action=list';" title="生成该模块所有栏目"/>&nbsp;&nbsp;
...
<tr align="center">
<td><?php echo category_select('catid', '选择栏目', 0, $moduleid);?></td>
<td><input type="text" size="5" name="num" value="100"/></td>
<td>
