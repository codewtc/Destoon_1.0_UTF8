...
<input type="radio" name="post[typeid]" value="<?php echo $k;?>" <?php if($k==0) echo 'checked';?> onclick="$('title').value='<?php echo $v;?>';" id="typeid_<?php echo $k;?>"/><label for="typeid_<?php echo $k;?>"> <?php echo $v;?></label>&nbsp;
<?php } ?>
</td>
</tr>
<tr>
...
<td>
	...
	<tr>
	<td width="70">需求数量</td>
	<td><input name="post[amount]" type="text" size="20"/></td>
	</tr>
	<tr>
	<td>价格要求</td>
	<td><input name="post[price]" type="text" size="20"/></td>
	</tr>
	<tr>
	<td>规格要求</td>
	<td><input name="post[standard]" type="text" size="20"/></td>
	</tr>
	<tr>
	<td>包装要求</td>
	<td><input name="post[pack]" type="text" size="20"/></td>
	</tr>
	</table>
</td>
</tr>
