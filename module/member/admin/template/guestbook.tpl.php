...
<td class="px11" title="IP-<?php echo $v['ip'];?>"><a href="<?php echo $MODULE[3]['linkurl'];?>redirect.php?username=<?php echo $v['username'];?>" target="_blank"><?php echo $v['poster'];?></a></td>
<td class="px11"><?php echo $v['adddate'];?></td>
<td class="px11"><?php echo $v['replydate'];?></td>
<td>
