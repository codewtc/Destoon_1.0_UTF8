...
class news {
    ...
    function news() {
		...
		$this->db = &$db;
		$this->fields = array('title','style','status','username','addtime','eidtor','edittime','linkurl','note');
    }
	...
	function update($itemid) {
		...
		$linkurl = userdomain($r['username']).rewrite('index.php?homepage='.$r['username'].'&file=news&itemid='.$itemid);
