...
show_menu($menus);
?>
<form method="post" action="?moduleid=3&file=<?php echo $file;?>&action=<?php echo $action;?>&pid=<?php echo $pid;?>" id="dform" onsubmit="return check();">
...
<tr id="wh" style="display:<?php echo $typeid == 3 || $typeid == 4 ? '' : 'none';?>">
...
<option value="5"<?php if($moduleid == 5) echo ' selected';?>><?php echo $MODULE[5]['name'];?></option>
<option value="6"<?php if($moduleid == 6) echo ' selected';?>><?php echo $MODULE[6]['name'];?></option>
<option value="7"<?php if($moduleid == 7) echo ' selected';?>><?php echo $MODULE[7]['name'];?></option>
<option value="4"<?php if($moduleid == 4) echo ' selected';?>><?php echo $MODULE[4]['name'];?></option>
