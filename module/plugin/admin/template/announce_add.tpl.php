...
<td><?php echo type_select('announce', 1, 'post[typeid]', '请选择分类', 0, 'id="typeid"');?> <span id="dtypeid" class="f_red"></span></td>
</tr>
<tr>
<td class="tl">公告有效期</td>
<td><?php echo dcalendar('post[fromtime]', timetodate($DT_TIME, 3));?> 至 <?php echo dcalendar('post[totime]');?></td>
</tr>
<tr>
...
<tr>
<td class="tl">内容模板</td>
<td><?php echo tpl_select('announce', $module, 'post[template]', '默认模板');?></td>
</tr>
</tbody>
</table>
