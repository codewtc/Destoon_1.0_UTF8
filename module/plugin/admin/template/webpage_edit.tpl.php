...
show_menu($menus);
?>
<form method="post" action="?moduleid=<?php echo $moduleid;?>&file=<?php echo $file;?>&action=<?php echo $action;?>&item=<?php echo $item;?>&itemid=<?php echo $itemid;?>" id="dform" onsubmit="return check();">
