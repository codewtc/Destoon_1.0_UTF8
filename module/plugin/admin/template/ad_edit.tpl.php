...
show_menu($menus);
?>
<form method="post" action="?moduleid=<?php echo $moduleid;?>&file=<?php echo $file;?>&action=<?php echo $action;?>&aid=<?php echo $aid;?>" id="dform" onsubmit="return check();">
...
<tr>
<td class="tl">所属行业</td>
<td><?php echo ajax_category_select('ad[key_catid]', '请选择', $key_catid, 1);?><?php tips('如果选择，则参与行业列表排名');?></td>
</tr>
<tr>
<td class="tl">关键字</td>
