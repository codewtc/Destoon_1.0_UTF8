...
<option value="status=3">正常发布的信息</option>
<option value="thumb!='' and status=3">有图的信息</option>
<option value="vip>0 and status=3"><?php echo VIP;?>信息</option>
</select>
...
<option value="editdate desc,vip desc">按VIP排序</option>
...
<input type="checkbox" id="child"/> 包含子栏目
</td>
<td>$catid</td>
</tr>
<tr>
...
<form method="post" action="?file=<?php echo $file;?>&action=preview" target="destoon_tag" onsubmit="return check();">
<input type="hidden" id="tag_expires" name="tag_expires"/>
<div class="tt">标签代码</div>
<table cellpadding="2" cellspacing="1" class="tb">
<tr>
<td class="tl">自定义CSS</td>
<td><textarea name="tag_css" id="tag_css"  style="width:98%;height:40px;font-family:Fixedsys,verdana;overflow:visible;color:green;">.newtag{width:300px;}
.newtag li{height:22px;ling-height:22px;overflow:hidden;}</textarea> 
</td>
</tr>
<tr>
<td class="tl">HTML开始标签</td>
<td><input type="text" name="tag_html_s" id="tag_html_s" size="30" value="<div class=&#34;newtag&#34;>" style="font-family:Fixedsys,verdana;"/></td>
</tr>
<tr>
...
<td><input type="text" name="tag_html_e" id="tag_html_e" size="10" value="</div>" style="font-family:Fixedsys,verdana;"/></td>
</tr>
<tr>
<td class="tl"></td>
<td>
...
<td class="tl">常用字段</td>
<td>
<strong>title</strong> 标题； <strong>linkurl</strong> 链接； <strong>catid</strong> 栏目ID； <strong>introduce</strong> 简介； <strong>addtime</strong> 添加时间；
</td>
</tr>
<tr>
<td class="tl">常用函数</td>
