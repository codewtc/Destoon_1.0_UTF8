...
show_menu($menus);
?>
<form method="post" action="?file=<?php echo $file;?>&action=delete">
...
<form method="post" action="?file=<?php echo $file;?>&action=upload" enctype="multipart/form-data">
...
<form method="post" action="?file=<?php echo $file;?>&action=runsql" onsubmit="return check();">
<div class="tt">执行SQL</div>
<table cellpadding="2" cellspacing="1" class="tb">
<tr>
<td>&nbsp;&nbsp;<textarea name="sql" id="sql" style="width:500px;height:50px;overflow:visible;"></textarea></td>
</tr>
<tr>
<td>
