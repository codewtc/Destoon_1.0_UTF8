...
<td id="name">我的面板</td>
<td width="30">
<a href="<?php echo DT_PATH;?>" target="_blank"><img src="<?php echo IMG_PATH;?>home.gif" width="8" height="8" title="网站首页"/></a>&nbsp;
<a href="?file=logout" target="_top" onclick="if(!confirm('确实要注销登录吗?')) return false;"><img src="<?php echo IMG_PATH;?>quit.gif" width="8" height="8" title="注销登录"/></a>
</td>
<td width="5"></td>
</tr>
</table>
...
<div id="menu">
	...
	<dd onclick="c(this);"><a href="?file=mymenu">自定义面板</a></dd>
	<?php
...
<div style="display:none;">
	<div id="m_1">
	<dl> 
	<dt onclick="s(this)" onmouseover="this.className='dt_on';" onmouseout="this.className='';">常用操作</dt> 
	<dd onclick="c(this);"><a href="?file=setting">网站设置</a></dd>
	<dd onclick="c(this);"><a href="?file=module">模块管理</a></dd>
	<dd onclick="c(this);"><a href="?file=category">行业管理</a></dd>
	...
	<dd onclick="c(this);"><a href="?action=template">更新模板</a></dd>
	</dl>
	...
	<?php
		...
		if(is_file($menuinc)) {
			...
			include $menuinc;
			echo '<dl id="dl_'.$moduleid.'">';
			echo '<dt id="dt_'.$moduleid.'" onclick="s($(\'dt_oth\'));s(this);" onmouseover="this.className=\'dt_on\';" onmouseout="this.className=\'\';">'.$name.'管理</dt>';
			foreach($menu as $m) {
				echo '<dd onclick="c(this);" style="display:none;"><a href="'.$m[1].'">'.$m[0].'</a></dd>';
			}
			echo '</dl>';
	...
	<dl id="dl_oth"> 
	<dt id="dt_oth" onclick="s($('dt_4'));s(this)" onmouseover="this.className='dt_on';" onmouseout="this.className='';">会员相关</dt> 
