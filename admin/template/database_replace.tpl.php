...
show_menu($menus);
?>
<form method="post" action="?file=<?php echo $file;?>&action=<?php echo $action;?>" onsubmit="return check();">
<div class="tt">字符替换</div>
...
<tr>
<td class="tl">替换为 <span class="f_red">*</span></td>
...
<div class="sbt"> <input type="submit" name="submit" value=" 执 行 " class="btn"/></div>
</form>
