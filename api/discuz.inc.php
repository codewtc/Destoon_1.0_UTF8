...
if($action == 'login') {
	$gender = $gender == 0 ? 2 : 1;
	$txt = "time=$DT_TIME&cookietime=$cookietime&username=$username&password=$password&secques=".substr(md5(random(8)), 16, 8)."&gender=$gender&email=$email&regip=$regip&regdate=$regtime&oicq=$qq&msn=$msn&showemail=0";
